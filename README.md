...
P.S. В процессе работы над проектом я осознал важность единообразия языка коммитов. В данном репозитории встречаются коммиты на разных языках; в дальнейших проектах используется английский язык как стандарт.

❗❗❗ Уважаемый разработчик ❗❗❗
Если вам лень листать код, загляните пожалуйста в PROJECT_ASSESSMENT.md
Я попросил ИИ -> сделать оценку моего проекта и выявить плюсы и минусы моего подхода.
❗❗❗ Я МОГ исправить минусы, но не стал этого делать, чтобы вы явно видели + и - моего решения
